...
def multi_analysis():
    ...
    if request.method == 'POST':
        try:
            ...
            msg = "정확한 값을 입력하세요"
            return render_template('Finished_multi_analysis_home.html', enumerate=enumerate, youtube_col_list=youtube_col_list, corona_col_list=corona_col_list, msg=msg, category_list=new_category_list)
        if int(category_id) == 0:
            ...
            data = base64.b64encode(buf.getbuffer()).decode("ascii")
            plt.close(fig)
            return render_template('Finished_multi_analysis_result.html', data=data, selection_1=selection_1, selection_2=selection_2)
        else:
            #먼저 카테고리로 추출
            ...
            data = base64.b64encode(buf.getbuffer()).decode("ascii")
            plt.close(fig)
            return render_template('Finished_multi_analysis_category_based_result.html', data=data, selection_1=selection_1, selection_2=selection_2, category_id_name=category_id_name)
    else:
        return render_template('Finished_multi_analysis_home.html', enumerate=enumerate, youtube_col_list=youtube_col_list, corona_col_list=corona_col_list, category_list=new_category_list)
...
def corona_related_multi_analysis():
    ...
    if request.method == 'POST':
        try:
            ...
            msg = "정확한 값을 입력하세요"
            return render_template('Finished_corona_related_multi_analysis_home.html', enumerate=enumerate, youtube_col_list=youtube_col_list, category_list=category_list, corona_col_list=corona_col_list, msg=msg)
        ...
        data = base64.b64encode(buf.getbuffer()).decode("ascii")
        plt.close(fig)
        return render_template('Finished_corona_related_multi_analysis_result.html', data=data, selection_1=selection_1, selection_2=selection_2)
    else:
        return render_template('Finished_corona_related_multi_analysis_home.html', enumerate=enumerate, youtube_col_list=youtube_col_list, corona_col_list=corona_col_list, category_list=category_list)
...
def corona_category():
    if request.method == 'POST':
        try:
            ...
            msg = "정확한 값을 입력하세요"
            return render_template('Finished_correlation_bokeh_home.html', category_list = category_list, msg=msg)
        category_id = request.form['category_id']
        category_id_name = category_list[category_id]
